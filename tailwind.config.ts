  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        "card-hover": "0 4px 16px -4px rgba(0, 0, 0, 0.12), 0 8px 24px -8px rgba(0, 0, 0, 0.08)",
        "button": "0 2px 8px -2px hsl(var(--primary) / 0.3)",
        "button-hover": "0 4px 16px -4px hsl(var(--primary) / 0.4)",
      },
    },
  },
